...
def login_email_service_provider(logged_in_admin: Page) -> Page:
    ...
    # Fixed: Use single quotes inside f-string or get value separately
    email = os.getenv('MAIL_DEBUG_EMAIL', 'test@example.com')
    password = os.getenv('MAIL_DEBUG_PASSWORD')
